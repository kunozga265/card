...
{{--                                        </div>--}}
                            ...
                            <div class="px-10 p-6 overflow-y-auto">
                                <ul class="space-y-2 text-sm">
                                    ...
                                    <li>
                                        <a href="{{route("experts.index")}}" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                                            <i class="mdi mdi-card-account-details-outline"></i>
                                            <span class="ms-3">Experts</span>
                                        </a>
                                    </li>
                                </ul>
                            </div>
